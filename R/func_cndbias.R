...
#'
#' Calculate the conditional bias given that a trial stopped at an interim analysis
#'
...
#'
#' @return Conditional bias in drift scale given the trial has stopped at \code{i}th analysis of information
...
#'#fraction 0.2,0.4,0.6 and 0.8, with Pocock type boundary, and drift 5
